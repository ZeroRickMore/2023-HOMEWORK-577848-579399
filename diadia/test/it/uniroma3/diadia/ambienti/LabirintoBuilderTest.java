...
public class LabirintoBuilderTest {
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente,labirintoBuilder.getMapNome2Stanza().get("stanza bloccata").getStanzaAdiacente("nord"));	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata,labirintoBuilder.getMapNome2Stanza().get("stanza bloccata").getStanzaAdiacente("nord"));
	}
