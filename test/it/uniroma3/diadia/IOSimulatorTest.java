...
class IOSimulatorTest {
	...
	void testAiuto() {
		...
		assertEquals("aiuto" ,this.ioS.getComandiStampati().get(0));
		assertEquals("fine" ,this.ioS.getComandiStampati().get(1));
		assertEquals("guarda" ,this.ioS.getComandiStampati().get(2));
		assertEquals("interagisci" ,this.ioS.getComandiStampati().get(3));
		assertEquals("posa" ,this.ioS.getComandiStampati().get(4));
		assertEquals("prendi" ,this.ioS.getComandiStampati().get(5));
		assertEquals("regala" ,this.ioS.getComandiStampati().get(6));
		assertEquals("saluta" ,this.ioS.getComandiStampati().get(7));
		assertEquals("vai" ,this.ioS.getComandiStampati().get(8));
		assertEquals(comandoAiuto.getFineElenco(),this.ioS.getComandiStampati().get(9));
	...
	void testTotaleNoErrori() { 
		for(String i : this.comandiDaIniettare)
			try {this.diaDia.processaIstruzione(i);}
	...
	void testStanzaBloccata() {
		Labirinto labirintoBloccato = new Labirinto.LabirintoBuilder()
				.addStanzaVincente("arrivo")
				.addStanzaBloccata("partenza locked", Direzione.nord, "chiave")
				.setComeStanzaIniziale("partenza locked")
				.addAdiacenza("partenza locked", "arrivo", Direzione.nord)
				.getLabirinto();
		...
		assertEquals(this.comandiDaIniettare.get(6), this.ioS.getComandoAppenaLetto());
		assertEquals(this.ioS.getComandiDaIniettare().get(6), this.ioS.getComandoAppenaLetto());
		assertEquals(diaDiaBloccato.getPartita().getLabirinto().getStanzaVincente().getStanzaAdiacente(Direzione.sud).getNome(), "partenza locked");
		assertEquals("partenza locked",diaDiaBloccato.getPartita().getStanzaCorrente().getNome());
	...
	void testStanzaMagica() {
		Labirinto labirintoMagico = new Labirinto.LabirintoBuilder()
	...
	void testStanzaBuia() {
		...
		Labirinto labirintoBuio = new Labirinto.LabirintoBuilder()
